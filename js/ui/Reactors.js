...
new e(this.game,a).canBuy()?i.removeClass("cantBuy").html("购买"):i.addClass("cantBuy").html("太贵了")}}},n.prototype.destroy=function(){this.game.getEventManager().removeListenerForType(a),this.container.html(""),this.container=null},n})
