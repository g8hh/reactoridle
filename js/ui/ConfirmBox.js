define(["text!template/confirmBox.html"],function(t){var i=function(t,i,n){this.id=String(Math.round(1e13*Math.random())),this.title=t,this.message=i,this.okButtonTitle="Ok",this.cancelButtonTitle="Cancel",this.okCallback=n,this.style="warning"}
