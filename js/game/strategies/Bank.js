...
return t.getInfoText=function(e,n){return'<span class="description">Boosts surrounding offices sell amount <b>'+nf(1+t._getBonus(e,n))+"</b> times.</span>"},t.prototype.calculateTileBonuses=function(e){var n=this.tile.findOffsetTiles([[-1,0],[0,-1],[1,0],[0,1]],function(t){return t.getMeta()&&"PowerToMoneyConverter"==t.getMeta().strategy.type})
