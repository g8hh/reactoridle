...
return e.strategy.waterProduction>0&&(n+='<span class="productionTitle">Produces water: </span><b class="power">'+nf(r._getWaterProduction(t,e))+"</b> "),n},r.prototype.getInfoText=function(){return r.getInfoText(this.tile.getReactor(),this.tile.getMeta(),this)},r.prototype.calculateWater=function(){var t=this.tile.getWater()+this._getWaterProduction()
