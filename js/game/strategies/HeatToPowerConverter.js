...
s>0&&(n+=s,r=' Water bonus: <b class="heat">'+nf(s)+"</b>")}return'<span class="description">Converts <b class="heat">'+nf(n)+"</b> heat in it to power."+r+"</span>"},t.prototype.getInfoText=function(){return t.getInfoText(this.reactor,this.tile.getMeta(),this.tile)},t.prototype.calculate=function(e){var i=Math.min(this.tile.getHeat(),t._getAmount(this.reactor,this.tile.getMeta()))
